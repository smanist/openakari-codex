...
- [ ] Extend `NOISE_MAP` with additional config-driven noise kinds [skill: execute] [requires-frontier]
...
- [ ] Add regression coverage for new noise kinds and reproducibility [skill: execute] [requires-frontier]
