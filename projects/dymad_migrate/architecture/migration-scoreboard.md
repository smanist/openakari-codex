...
| `training` | `projects/dymad_migrate/architecture/training-layer-design.md` | `modules/dymad_migrate/src/dymad/training/phase_pipeline.py`, `modules/dymad_migrate/src/dymad/training/stacked_opt.py`, `modules/dymad_migrate/src/dymad/training/phase_runtime.py` | `modules/dymad_migrate/tests/test_training_phase_runtime.py`, `modules/dymad_migrate/tests/test_workflow_lti.py::test_lti[7]`, `projects/dymad_migrate/analysis/2026-04-04-phase-pipeline-prototype-verification.md` | `prototype` | `StackedOpt` now delegates phase sequencing through a first-class `PhasePipeline` while preserving current phase-config compatibility |
