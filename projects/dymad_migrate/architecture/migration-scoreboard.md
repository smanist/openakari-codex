...
| `model-spec` | `projects/dymad_migrate/architecture/model-spec-design.md` | `modules/dymad_migrate/src/dymad/models/model_spec.py`, `modules/dymad_migrate/src/dymad/models/collections.py`, `modules/dymad_migrate/src/dymad/models/helpers.py` | `modules/dymad_migrate/tests/test_model_spec_adapter.py` | `prototype` | Predefined-model constructors now build typed `ModelSpec` compatibility objects before crossing the legacy builder seam |
...
- model-spec now has a concrete compatibility prototype, but training and spectral-analysis seams remain design-led
