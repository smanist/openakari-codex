...
|---|---|---|---|---|---|
| `data` | `projects/dymad_migrate/architecture/data-layer-design.md` | `modules/dymad_migrate/src/dymad/core/series.py`, `modules/dymad_migrate/src/dymad/io/series_adapter.py`, `modules/dymad_migrate/src/dymad/io/trajectory_manager.py` | `modules/dymad_migrate/tests/test_regular_series_adapter.py` | `prototype` | First regular-series seam exists for regular trajectories only; graph/path-wide adoption not started |
| `transform` | `projects/dymad_migrate/architecture/transform-layer-design.md` | none | none | `design-only` | Legacy transform stack remains the active implementation |
